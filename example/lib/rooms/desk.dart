...
final Room desk = Room(
  ...
  interactables: [
    ...
    Clue(
      ...
      lockedDialog: const EscapeGameDialog(message: 'Le coffre derrière ce tableau est protégé par un cadenas fermé à clé...'),
    ),
    Clue(
      id: 'wardrobe',
      renderSettings: const InteractableRenderSettings(
      ...
      lockedDialog: const EscapeGameDialog(message: 'Cette armoire est protégée par un cadenas fermé à clé...'),
    ),
  ],
);
